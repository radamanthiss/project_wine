...
<body style="padding-top: 50px;" onload="nobackbutton();">
<div class="content-w3ls agileits w3 wthree w3-agile w3-agileits agileinfo agile container">
<h1 class="agileits w3 wthree w3-agile w3-agileits agileinfo agile">Show answer</h1>
<form action="{{url('show')}}" method="post" class="form-agileits" id="formulario" name="formulario" >
	<p style="color: ghostwhite;margin-bottom: 1rem;">Click on the button to know the status of the order</p>
